    ...
    <footer id="contact" class="bg-stone-950 text-stone-500 py-32 px-10 border-t border-stone-900">
        <div class="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-20">
            <div class="col-span-1 md:col-span-2">
                ...
                <p class="text-lg max-w-sm mb-12 leading-relaxed">A sanctuary of style and sophistication in Colombo. We are committed to excellence, redefining beauty one guest at a time.</p>
        ...
        <div class="max-w-7xl mx-auto mt-32 pt-12 border-t border-stone-900 flex flex-col md:flex-row justify-between items-center text-xs uppercase tracking-widest opacity-40">
            <div>&copy; 2026 GLOW & STYLE SALON. CRAFTED BY ANTIGRAVITY.</div>
            <div class="mt-4 md:mt-0">MADE WITH PASSION IN COLOMBO</div>
        </div>
    </footer>
</body>
</html>
